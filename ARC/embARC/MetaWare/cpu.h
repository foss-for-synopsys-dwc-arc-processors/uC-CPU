...
* Version  : V1.31.04
*********************************************************************************************************
* Note(s)  : This port supports the ARC EM architectures.
*********************************************************************************************************
*/
...
typedef  uint8_t        CPU_CHAR;                        /*  8-bit character                                     */
...
#define  CPU_CFG_STK_ALIGN_BYTES  (4u)                          /* Defines CPU stack alignment in bytes. (see Note #2). */
...
#define  CPU_INT_DIS()         do { cpu_sr = arc_lock_save(); } while (0) /* Save    CPU status word & disable interrupts.*/
#define  CPU_INT_EN()          do { arc_unlock_restore(cpu_sr); } while (0) /* Restore CPU status word.                     */
